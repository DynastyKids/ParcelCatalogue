    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link" href="https://botany.testingstar.top">Offline Mode</a></li>
                <li class="nav-item"><a class="nav-link" href="/add">Add missing street</a></li>
                <li class="nav-item"><a class="nav-link" href="/manages">Modify the list</a></li>
            </ul>
        </div>
    </div>
</nav>
