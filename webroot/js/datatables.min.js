 ...
 *
 * Included libraries:
 *  jQuery 3.3.1, DataTables 1.10.25
 */
...
(function (k) {
    ...
    u.ext = L = {
        buttons: {},
        classes: {},
        builder: "bs5/jq-3.3.1/dt-1.10.25",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (a) {
    ...
    a.extend(!0, d.defaults, {
        dom: "<'row'<'col-sm-8 col-md-8'f><'col-sm-4 col-md-4'l>><'row'<'col-sm-12'tr>><'row'<'col-sm-6 col-md-8'i><'col-sm-6 col-md-4'p>>",
        renderer: "bootstrap"
    });
